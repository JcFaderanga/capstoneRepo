...
const ContentTitleButton = ({title, icon,backIcon, onPress, size}) => {
  return (
    <TouchableOpacity className=" flex-row justify-between items-center w-full h-16 border-b-2 border-[#F2F2F2]"
            onPress={onPress}>      
            ...
            <View className="w-20 h-full flex justify-center items-center">
                <Image source={backIcon} className="h-4 w-5" resizeMode='contain'/>
            </View>
    </TouchableOpacity>
  )
}
