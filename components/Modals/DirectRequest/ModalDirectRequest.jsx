        ...
        <ScrollView>
          <View className="px-10 my-4">
            ...
            <View className="flex-row flex-1 justify-between items-center ">
              <Text className="text-base">
                Blood type{" "}
                <Text className="text-primaryRed font-bold">
              ...
              <View className="flex-row border rounded-xl bg-gray-50 border-gray-300 w-[115px] h-9 justify-evenly items-center">
                <Pressable
                  onPress={() =>
                    requestUnits > 1 && setRequestUnits(requestUnits - 1)
                  }
                  className="p-2"
                >
                  <Image
                ...
                <Pressable
                  onPress={() => setRequestUnits(requestUnits + 1)}
                  className="px-2"
                >
                  <Image
          ...
          <View className="flex-1 flex-row justify-between items-center px-8 h-20">
            ...
            <ToggleButton
              ...
              AlterDescription={
                "Turning on Anonymous Request will hide your name and profile from the feed."
              }
            />
          </View>
