  ...
  return (
    <View className="mt-5 py-1 flex items-center">
      ...
      <View className="flex justify-center rounded-[15px] ">
        <TextInput
          className="
                    w-[310px] h-[56px] rounded-[15px] p-4 text-lg bg-gray-50 border border-[#e4e4e4]
                    focus:bg-gray-100 focus:border-2 focus:border-gray-100"
          style={validationError ? { borderColor: "red", borderWidth: 2 } : {}}
        ...
        />
        <Text className="px-2 absolute bottom-[-20] text-primary_red">
          {validationError}
        </Text>
      </View>
    </View>
