                        ...
                        <View className=" h-auto px-2 py-1 flex-row items-center">
                            <Image source={homeIcons.target} className="w-10 h-10 rounded-full mx-3" resizeMode='contain'/>
                              <View className="relative flex-1">
                                  <Text className="text-base font-bold flex-wrap">{details?.title}</Text>
                                  <Text className="text-[12px] ">{details?.time_posted}</Text>
                              </View>
                        </View>       
                    </View>
                </View>
            <View className=" border-b-2 border-gray-100 py-2">
                <Text className="my-2 mx-4 text-gray-500 text-sm">{details?.address}</Text>
            </View>        
                <View className=" flex-row justify-between items-center px-4 py-3">
                    <View className=" flex-row items-center  pl-2">
                        ...
                        <View className="px-2">
                            <Text className="text-[16px] ">{details?.date}</Text>
